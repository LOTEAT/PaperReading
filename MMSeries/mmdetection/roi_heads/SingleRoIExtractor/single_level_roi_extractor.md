<!--
 * @Author: LOTEAT
 * @Date: 2024-09-04 17:34:03
-->
## SingleRoIExtractor
- 前置知识：PyTorch, <a href='../SingleRoIExtractor/single_level_roi_extractor.md'>SingleRoIExtractor</a>
- [代码链接](https://github.com/open-mmlab/mmdetection)
### 1. Code
`SingleRoIExtractor`是对RoI进行封装的类，主要作用就是提取特征。
```python
