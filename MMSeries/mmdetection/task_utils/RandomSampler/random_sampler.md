<!--
 * @Author: LOTEAT
 * @Date: 2024-08-20 09:39:59
-->
## Random Sampler
- 前置知识：<a href='../Basic/Sampler/sampler.md'>Sampler</a>, <a href='../Basic/SamplingResult/sampling_result.md'>SamplingResult</a>
- [代码链接](https://github.com/open-mmlab/mmdetection)


### 1. Random Sampler
这个类的核心功能在于随机采样，对正负样本按照比例进行采样。
